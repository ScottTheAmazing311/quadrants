    ...
    <div className="min-h-screen industrial-base relative py-16">
      ...
      <div className="container mx-auto px-4 max-w-2xl relative z-10">
        ...
        <div className="premium-card rounded-none p-8 md:p-12">
          ...
          {success && (
            <div className="mb-6 p-4 bg-green-900/20 border-2 border-burnt-orange rounded-none text-burnt-orange">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-bg-warm-2 border-2 border-amber-secondary/30 text-white rounded-none focus:border-amber-secondary focus:outline-none transition-colors"
